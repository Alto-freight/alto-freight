...
export function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:admin@altofreight.ca?subject=${encodeURIComponent(
      subject
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12">
          ...
          <aside className="lg:col-span-5 lg:col-start-8 space-y-6">
            <a href="tel:7783889988" className="group block bg-[#0f1729] text-white p-8 hover:bg-[#1a2235] transition-colors duration-300">
